			...
			if( $animate ){
				...
				if( $link ){
					...
					$output .= '<div class="desc_wrapper">';
						...
						if( $slogan ){
							$output .= '<p>'. wp_kses( $slogan, $allowed_html ) .'</p>';
						}
						if( $title ){
							$output .= '<h4>'. wp_kses( $title, $allowed_html ) .'</h4>';
						}
	...
	function sc_helper( $attr, $content = null )
	{
		...
		$output = '<div class="helper">';
			...
			$output .= '<div class="helper_header">';
				...
				if( $title ){
					$output .= '<'. esc_attr( $title_tag ) .' class="title">'. wp_kses( $title, $allowed_html ) .'</'. esc_attr( $title_tag ) .'>';
				}
				...
				$output .= '<div class="links">';
					...
					if( $title1 ){
						if( $link1 ){
							// This variable has been safely escaped above in this function
							$output .= '<a class="link link-1 '. esc_attr( $class1 ) .'" href="'. esc_url( $link1 ) .'" '. $target_1_escaped .'>'. wp_kses( $title1, $allowed_html ) .'</a>';
						} else {
							$output .= '<a class="link link-1 toggle" href="#" data-rel="1">'. wp_kses( $title1, $allowed_html ) .'</a>';
						}
					}
					...
					if( $title2 ){
						if( $link2 ){
							// This variable has been safely escaped above in this function
							$output .= '<a class="link link-2 '. esc_attr( $class2 ) .'" href="'. esc_url( $link2 ) .'" '. $target_2_escaped .'>'. wp_kses( $title2, $allowed_html ) .'</a>';
						} else {
							$output .= '<a class="link link-2 toggle" href="#" data-rel="2">'. wp_kses( $title2, $allowed_html ) .'</a>';
						}
					}
			...
			if( $animate ){
				...
				if( $link ){
					...
					$output .= '<div class="desc_wrapper">';
						...
						if( $title ){
							$output .= '<h3 class="themecolor">'. wp_kses( $title, $allowed_html ) .'</h3>';
			...
			if( $animate ){
				...
				if( $link ){
					...
					$output .= '<div class="desc">';
						...
						if( $slogan ){
							$output .= '<div class="subtitle">'. wp_kses( $slogan, $allowed_html ) .'</div>';
						}
						if( $title ){
							$output .= '<h2>'. wp_kses( $title, $allowed_html ) .'</h2>';
						}
